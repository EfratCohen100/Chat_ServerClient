...
public class ClientGui extends javax.swing.JFrame {
	...
	{
		this.jTextArea_Reply.setText(msg);
	}
	...
	private void initComponents() {
		...
		jTextArea_Reply = new javax.swing.JTextArea("");
		...
		jTextArea_Reply.setColumns(20);
		jTextArea_Reply.setRows(5);
		jScrollPane1.setViewportView(jTextArea_Send);
		jScrollPane2.setViewportView(jTextArea_Reply);
	...
	private void Connect(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Connect
		...
		String clntMsg = my_name.getText()+" : "+"connect"; //jTextArea_Main.getText();
		Client.SendToServer(clntMsg);
	...
	private void Send(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Send
		...
		String command = message_field.getText();
		String message = jTextArea_Send.getText();
		String clntMsg = my_name.getText()+" : "+ command+","+ dst.getText()+","+message;//jTextArea_Main.getText();
		Client.SendToServer(clntMsg);
		//Client.Send();
	...
	private void Disconnect(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Disconnect
		...
		String clntMsg = my_name.getText()+" : "+ command+","+ my_name.getText();//jTextArea_Main.getText();
		Client.SendToServer(clntMsg);
	...
	private javax.swing.JTextArea jTextArea_Reply;
